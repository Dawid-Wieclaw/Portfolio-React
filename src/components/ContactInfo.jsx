...
export default function ContactInfo({ id, Icon, type, info, href }) {
    ...
    return (
        <a href={href}
            target="_blank">
            <div className="flex items-center rounded-xl text-gray-300 text-lg p-3 gap-10  bg-zinc-950 border border-zinc-800 hover:border-zinc-500 hover:border-2 transition">
